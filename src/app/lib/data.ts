...
import { FaProjectDiagram, FaServicestack, FaChalkboardTeacher, FaBusinessTime, FaLaptopHouse } from "react-icons/fa";
...
export const dashboardSections = [
  { route: "/dashboard/projects", label: "Manage Projects", icon: FaProjectDiagram },
  { route: "/dashboard/services", label: "Manage Services", icon: FaServicestack },
  { route: "/dashboard/workspaces", label: "Manage Workspaces", icon: FaLaptopHouse },
  { route: "/dashboard/training", label: "Manage Trainings", icon: FaChalkboardTeacher },
  { route: "/dashboard/internships", label: "Manage Internships", icon: FaBusinessTime },
];
